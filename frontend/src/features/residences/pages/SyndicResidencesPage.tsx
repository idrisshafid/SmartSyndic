  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="border-b backdrop-blur-md">
        <div className="mx-auto flex flex-col sm:flex-row items-start sm:items-center 
        justify-between px-4 sm:px-6 md:px-10 py-0.5 sm:py-6 gap-4">
          <div className="w-full sm:w-auto">
            <p className="text-1xl sm:text-1xl md:text-4xl font-bold tracking-tight">
              Residences
            </p>
          </div>
          ...
          <Link
            ...
            className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-2xl
             bg-orange-500 
            px-4 py-2.5 sm:px-5 sm:py-3 text-sm font-semibold text-white shadow-sm transition 
            hover:bg-orange-600 hover:shadow-md active:scale-[0.98]"
          >
            <Plus size={18} />
            New Residence
          </Link>
        </div>
        <p className="pb-2 text-base sm:text-lg md:text-xl items-center rounded-2xl tracking-tight
         px-4 sm:px-6 md:px-10 text-center sm:text-left">
          {isLoading
            ? "Loading..."
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-6 sm:py-10">
        ...
        {/* ERROR */}
        {isError && (
          <div className="flex flex-col items-center justify-center rounded-3xl border py-16 text-center px-4">
        ...
        {!isLoading && !isError && residences.length === 0 && (
          <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed py-20 text-center px-4">
            <Building2 size={40} />
            ...
            <Link
              to="/syndic/residences/create"
              className="mt-6 inline-flex items-center gap-2 rounded-2xl bg-orange-500 px-5 py-3 text-sm font-semibold text-white transition hover:bg-orange-600 active:scale-[0.98]"
            >
              <Plus size={18} />
              Create Residence
            </Link>
